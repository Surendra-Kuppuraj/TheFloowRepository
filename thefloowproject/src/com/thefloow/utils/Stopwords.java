...
public final class Stopwords {
	...
	public Stopwords() {
		stopwordsList = Arrays.asList("!", "''", "*", "**", "-", "-->", ";", "=", "==", "?", "??", "A", "B", "C", "D",
				...
				"Q", "R", "S", "a", "b", "c", "q", "w", "e", "r", "t", "y", "u", "p", "a", "S", "D", "f", "g", "h", "j",
				"k", "z", "x", "c", "v", "b", "n", "m", "Seven", "She", "Six", "T", "They", "Three", "Two", "X", "Y",
				"Z", "[", "[[", "]]", "a's", "able", "about", "above", "according", "accordingly", "across",
				...
				"had", "hadn't", "happens", "hardly", "has", "hasn't", "have", "haven't", "having", "he", "he'd",
				"he'll", "he's", "hello", "help", "hence", "her", "here", "here's", "hereafter", "hereby", "herein",
				"hereupon", "hers", "herself", "hi", "him", "himself", "his", "hither", "hopefully", "how", "how's",
				...
				"most", "mostly", "much", "must", "mustn't", "my", "myself", "name", "namely", "nd", "near", "nearly",
				...
				"several", "shall", "shan't", "she", "she'd", "she'll", "she's", "should", "shouldn't", "since", "six",
				...
				"when", "when's", "whence", "whenever", "where", "where's", "whereafter", "whereas", "whereby",
				"wherein", "whereupon", "wherever", "whether", "which", "while", "whither", "who", "who's", "whoever",
				"whole", "whom", "whose", "why", "why's", "will", "willing", "wish", "with", "within", "without",
